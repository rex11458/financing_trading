...
class LoginFrame(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        pnl = wx.Panel(self)
        self.acc = wx.TextCtrl(pnl,value='18573622170', style=wx.TE_LEFT,size=(200, 25), pos=(200, 60))
        self.pwd = wx.TextCtrl(pnl,value='ever11458', style=wx.TE_PASSWORD,size=(200, 25), pos=(200, 100))
